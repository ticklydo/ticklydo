...
const NAV: { id: string; label: string; path: string; svg: React.ReactElement }[] = [
  ...
  {
    id: "weekly-plan", label: "Týždenný plán", path: "/weekly-plan",
    svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14h2M14 14h2M8 17h2"/></svg>,
  },
  {
    id: "notes", label: "Poznámky", path: "/notes",
