...
export default function HomePage() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "#0b0c13", color: "#f0f0f8", fontFamily: "var(--font-geist-sans)" }}>

      {/* ── SIDEBAR ── */}
      <aside style={{
        width: 72, background: "#13141e",
        borderRight: "1px solid #22233a",
        ...
        <div style={{ width: 36, height: 1, background: "#22233a", margin: "6px 0" }} />
        ...
        <button title="Profil & Nastavenia" onClick={() => setActivePage("profile")}
          style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            cursor: "pointer", fontSize: 20, border: "none",
            background: activePage === "profile" ? "#1a1b28" : "transparent",
            color: activePage === "profile" ? "#f0f0f8" : "#6b6c80",
            position: "relative",
          }}>
          {activePage === "profile" && (
            <span style={{
        ...
        <button title="Odhlásiť sa"
          style={{
            ...
            background: "transparent", color: "#6b6c80",
          }}>↩️</button>
      </aside>

      {/* ── CONTENT ── */}
      <div style={{ flex: 1, overflowY: "auto", padding: "28px 28px 60px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        {activePage === "home" && (
          <>
            ...
            <div style={{ fontSize: 11, fontWeight: 800, color: "#6b6c80", textTransform: "uppercase", letterSpacing: "1.2px" }}>
              Naposledy otvorené
            </div>
            ...
            <div style={{ fontSize: 11, fontWeight: 800, color: "#6b6c80", textTransform: "uppercase", letterSpacing: "1.2px", marginTop: 4 }}>
              Pracovné priestory
            </div>

            <div style={{
              maxWidth: 480, background: "#1a1b28", border: "1px solid #22233a",
              borderRadius: 18, padding: "16px 18px",
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, fontWeight: 600, color: "#6b6c80", marginTop: 2 }}>4 projekty · 2 členovia</div>
              </div>
        ...
        {activePage === "work" && (
          <>
            ...
            <p style={{ color: "#6b6c80", fontWeight: 700 }}>Tu bude zoznam tvojich úloh.</p>
          </>
        )}
        ...
        {activePage === "notifications" && (
          <>
            ...
            <p style={{ color: "#6b6c80", fontWeight: 700 }}>Zatiaľ žiadne notifikácie.</p>
          </>
        )}
        ...
        {activePage === "profile" && (
          <>
            ...
            <div style={{ background: "#13141e", border: "1px solid #22233a", borderRadius: 18, padding: 20, display: "flex", flexDirection: "column", gap: 16, maxWidth: 480 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 11, fontWeight: 600, color: "#6b6c80", marginTop: 2 }}>Nastav si akúkoľvek kombináciu</div>
                </div>
                <div style={{ display: "flex", gap: 10 }}>
                  {[
                    ...
                    <div key={i} style={{ textAlign: "center" }}>
                      ...
                      <div style={{ fontSize: 10, fontWeight: 800, color: "#6b6c80", marginTop: 3 }}>{c.label}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* General settings */}
            <div style={{ background: "#13141e", border: "1px solid #22233a", borderRadius: 18, padding: 20, display: "flex", flexDirection: "column", gap: 18, maxWidth: 480 }}>
              <div style={{ fontSize: 13, fontWeight: 800, textTransform: "uppercase", letterSpacing: 1, color: "#6b6c80" }}>🛠 Všeobecné</div>
              {[
                { name: "Tmavý režim",  desc: "Aplikácia vždy v tmavom štýle" },
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div>
                    ...
                    <div style={{ fontSize: 11, fontWeight: 600, color: "#6b6c80", marginTop: 2 }}>{s.desc}</div>
                  </div>
                  <div onClick={() => setToggles(t => t.map((v,j) => j===i ? !v : v))}
                    style={{
                      width: 44, height: 24, borderRadius: 12, cursor: "pointer",
                      background: toggles[i] ? grad : "#22233a",
